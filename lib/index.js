...
function innerRpc(request, callback) {
    ...
    var errorMessage = 'NodeAlert JSON-RPC: ';
...
RpcClient.callspec = {
    ...
    znode: 'str',//https://github.com/zcoinofficial/zcoin/blob/master/src/rpc/rpcznode.cpp#L88
    znodebroadcast: 'str',//https://github.com/zcoinofficial/zcoin/blob/master/src/rpc/rpcznode.cpp#L584
    znodelist: 'str str',//https://github.com/zcoinofficial/zcoin/blob/master/src/rpc/rpcznode.cpp#L439
    ghostnode: 'str',//https://github.com/NixPlatform/NixCore/blob/master/src/ghostnode/rpcghostnode.cpp#L102
    ghostnodebroadcast: 'str',//https://github.com/NixPlatform/NixCore/blob/master/src/ghostnode/rpcghostnode.cpp#L623
    ghostnodelist: 'str str',//https://github.com/NixPlatform/NixCore/blob/master/src/ghostnode/rpcghostnode.cpp#L471
};
